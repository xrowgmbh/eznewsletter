...
<li id="n{$:newsletterType.id}_progress">
    ...
    <a class="nodetext" href={concat('newsletter/list_draft/',$:newsletterType.id)|ezurl} title="{$:toolTip}">
	<span class="node-name-normal">{'Drafts'|i18n( 'design/eznewsletter/contentstructuremenu' )}</span>
    </a>
</li>
        {/default}
    {/let}
