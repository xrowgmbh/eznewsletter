...
<li id="n{$:newsletterType.id}_progress">
    ...
    <a class="nodetext" href={concat('newsletter/list_recurring/',$:newsletterType.id)|ezurl} title="{$:toolTip}">
    <span class="node-name-normal">{'Recurring'|i18n( 'design/eznewsletter/contentstructuremenu' )}</span>
    </a>
</li>
        {/default}
    {/let}
