...
{
    var sendDateYear = document.getElementById( 'send_date_year' );
    var sendDateMonth = document.getElementById( 'send_date_month' );
    var sendDateDay = document.getElementById( 'send_date_day' );
    var sendDateHour = document.getElementById( 'send_date_hour' );
    var sendDateMinute = document.getElementById( 'send_date_minute' );
    if ( sendDateYear && sendDateMonth && sendDateDay && sendDateHour && sendDateMinute )
    {
        ...
        {
            var change = confirm( 'You entered a send date in the past. Do you want to set it to the current date and continue the publishing process?' );
            if ( change )
            {
            ...
            {
                return confirm( 'Do you want to continue the publishing process?' );
            }
        }
    }
    return true;
