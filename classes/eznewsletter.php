...
class eZNewsletter extends eZPersistentObject
{
    ...
    static function definition()
    {
        return array( 
            'fields' => array( 
                ...
                'recurrence_condition' => array( 
                    'name' => 'RecurrenceCondition' , 
                    'datatype' => 'string' , 
                    'default' => '' , 
                    'required' => true 
                ) , 
                'recurrence_last_sent' => array( 
                    'name' => 'SendStatus' , 
                    'datatype' => 'integer' , 
                    'default' => 0 , 
                    'required' => true 
    ...
    */
    ...
    {
        return eZPersistentObject::fetchObject( eZNewsletter::definition(), null, array( 
            'hash' => $hash , 
            'status' => $status 
        ), $asObject );
    }
    ...
    */
    ...
    function contentObjectVersion()
    {
        if ( eZContentObject::exists( $this->attribute( 'contentobject_id' ) ) )
        {
            return eZContentObjectVersion::fetchVersion( $this->attribute( 'contentobject_version' ), $this->attribute( 'contentobject_id' ) );
        }
        return false;
    }
    ...
    */
    function buildSendList()
    {
        ...
        foreach ( $newsletterType->attribute( 'subscription_list' ) as $newsletterSubscriptionLink )
        {
            ...
            while ( $subscriptionArray = $subscriptionList->fetchSubscriptionArray( $offset, eZNewsletter::MaxSubscriptionFetchLimit, true, eZSubscription::VersionStatusPublished, array( 
                array( 
    ...
    */
    static function fetchListBySendStatus( $sendStatus, $status = eZNewsletter::StatusPublished, $asObject = true, $additionalParameters = array() )
    {
        return eZPersistentObject::fetchObjectList( eZNewsletter::definition(), null, array_merge( array( 
            'send_status' => $sendStatus , 
            'status' => $status 
        ), $additionalParameters ), null, null, $asObject );
    }
    ...
    */
    static function fetchByContentObject( $contentObjectID, $contentObjectVersion = false, $status = eZNewsletter::StatusPublished, $asObject = true )
    {
        $condArray = array( 
        ...
        return eZPersistentObject::fetchObject( eZNewsletter::definition(), null, $condArray, $asObject );
    }
    ...
    */
    static function fetchByOffset( $offset, $limit, $status = eZNewsletter::StatusPublished, $asObject = true )
    {
        $newsletterArray = eZPersistentObject::fetchObjectList( eZNewsletter::definition(), null, array( 
            'status' => $status 
        ), array( 
            'id' => 'ASC' 
        ), array( 
    ...
    {
        $newsletter = eZNewsletter::fetch( $id, array( 
            array( 
    ...
    */
    ...
    {
        eZPersistentObject::removeObject( eZNewsletter::definition(), array( 
            'id' => $id 
        ) );
    }
    ...
    */
    static function create( $name = '', $userID = false, $newsletterTypeID )
    {
        ...
        $newsletter = new eZNewsletter( array( 
            'created' => time() , 
    ...
    */
    static function outputFormatNameMap()
    {
        ...
        return array( 
            eZNewsletter::OutputFormatText => ezpI18n::tr( 'eznewsletter/output_formats', 'Text' ) , 
    ...
    */
    ...
    {
        return array( 
            eZNewsletter::SendStatusNone => ezpI18n::tr( 'eznewsletter/send_status', 'Not sent' ) , 
    ...
    */
    ...
    {
        return array( 
            eZNewsletter::StatusDraft => ezpI18n::tr( 'eznewsletter/object_status', 'Draft' ) , 
    ...
    */
    ...
    {
        return array( 
            eZNewsletter::RecurrenceDaily => ezpI18n::tr( 'eznewsletter/recurrencetype', 'Daily' ) , 
